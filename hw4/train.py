...
def parse_args():
    ...
    parser.add_argument('--colmap_dir', type=str, default="/data8T/SA24001017/HCQ/DIP/hw3/04_3DGS/data/chair",
                      help='Directory containing COLMAP data (with sparse/0/ and images/)')
    parser.add_argument('--checkpoint_dir', type=str, default='/data8T/SA24001017/HCQ/DIP/hw3/04_3DGS/data/chair/checkpoints',
